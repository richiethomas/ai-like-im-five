...
7. VOICE — the author is a self-described learner writing a public learning log for non-technical readers, NOT an expert. Two things to flag:
   (a) Overclaimed authority: field-wide empirical claims the author cannot have observed ("almost everyone does this", "the most common mistake", "everyone knows"), verdicts stated as personal decree ("the right way and the wrong way", "here's what NOT to do"), or presumptive framings that tell the reader how to feel ("the obvious answer", "obviously", "of course", "as you'd expect"). Also flag the phrases "key insight" / "the key insight" / "key takeaway" (in headings or body): they overdramatize a routine point. Fix: attribute the judgment to its real source (the CS231n notes, named experts, standard practice), or reframe as what the author has personally laid out and observed, or replace the dramatizing phrase with a neutral signpost ("the main idea", "the main point") or state the point directly. Note: neutral signpost headings ("The Main Idea", "Why This Matters") are fine and should NOT be flagged; only the dramatizing "key insight"/"key takeaway" framing is banned. Quoting experts is fine; claiming their vantage point is not.
